...
export default function ReportHeader() {
    ...
    const listOfReports = useRecoilValue(generateReportAtom);
        ...
        <div className={styles['reportHeader']}>
            <div className={styles['leftSection']}>
                <div className={styles['bankNameCode']}>
                    ...
                    <div className={styles['displayText']}>{reportTitle?.bank_name}</div>
                </div>
                <div className={styles['bankNameCode']}>
                    <div className={styles['displayTitle']}>Bank Code: </div>
                    <div className={styles['displayText']}>{reportTitle?.bank_code}</div>
                </div>
            </div>
            ...
            <div className={styles['rightSection']}>
                <div className={styles['returnNameCode']}>
                    ...
                    <div className={styles['displayText']}>{reportTitle?.return_name}</div>
                </div>
                <div className={styles['returnNameCode']}>
                    <div className={styles['displayTitle']}>Return Code: </div>
                    <div className={styles['displayText']}>{reportTitle?.return_code}</div>
                </div>
            </div>
        </div>
    );
