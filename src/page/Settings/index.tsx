			...
			<div className={styles["container"]}>
				...
				<div className={styles["settings_card"]}>
					<header className={styles["header"]}>
						<p onClick={setAccountInformation}>Account Information</p>
						...
						<>
							<main className={styles["change_password"]}>
								<p className={styles["title"]}>
									Verify it’s you by entering your email and current password
								</p>
								<div className={styles["content"]}>
									<InputGroup
										type='email'
					...
					{tab === "otp" && activeTab === "change_password" ? <Otp /> : null}
					{tab === "new_password" && activeTab === "change_password" ? (
						<NewPassword />
					) : null}
				</div>
			</div>
